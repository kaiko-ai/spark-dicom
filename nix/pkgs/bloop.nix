...
stdenv.mkDerivation rec {
  ...
  bloop-coursier = stdenv.mkDerivation rec {
    ...
    platform =
      ...
      else if stdenv.isDarwin && (stdenv.isx86_64 || stdenv.isAarch64) then "x86_64-apple-darwin"
    ...
    outputHash =
      ...
      else if stdenv.isDarwin && (stdenv.isx86_64 || stdenv.isAarch64) then "0x5yqf3i8y6s5h27yr0jkpvj6ch25ckx2802dmaxlgq6gz0fx6w2"
      else throw "unsupported platform";
  };
